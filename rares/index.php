...
<head>
  <meta charset="utf-8">
  <title>Catálogo de HLandia - Rares</title>
        ...
        <div class="row">
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Rares</li>
            </ul>
          </div>
          <div class="span4">
            <div class="search">
              <form class="input-append">
                <input class="search-form" id="myInput" type="text" onkeyup="myFunction()" placeholder="Buscar un rare por su nombre.." />
          ...
          <div class="span12">
            <div class="centered">
              <table class="table table-hover" id="myTable" cellspacing="0">
						...
						<tbody>
							<?php
	$sql = ("SELECT ID, imagen, nombre, valor, descripcion, categoria FROM rares WHERE categoria = 'rares' order by valor DESC");
