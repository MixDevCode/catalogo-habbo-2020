...
<html lang="en">
  <head>
    <title>Panel de Administración - Rares</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><img src="admin/assets/rares.png" /> Rares</h1>
          <p>Aquí puedes editar o eliminar rares.</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item active"><a href="#">Rares</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
	  ...
	  <tbody>
    <?php 
		$sql = ("SELECT ID, imagen, nombre, valor, descripcion, categoria FROM rares WHERE categoria = 'rares'");
